...
# country_series, water_limit=None
    ...
    hexagons.to_file('Resources/0Spatial/ratio_total/Northern/hex_lcoh.geojson', driver='GeoJSON', encoding='utf-8')
    # hexagons.to_file('Resources/hex_lcoh_spatial.geojson', driver='GeoJSON', encoding='utf-8')
