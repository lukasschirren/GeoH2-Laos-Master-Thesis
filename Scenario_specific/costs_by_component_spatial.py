...
year = 'Vientiane'
base_path = 'Resources/0Spatial/ratio_total'
hex_file_name = 'hex_total_cost.geojson'

# Construct the path
hex_path = os.path.join(base_path, year, hex_file_name)

# Load hexagons
hexagons = gpd.read_file(hex_path)

# Load necessary parameters
demand_excel_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\demand_parameters.xlsx'
demand_parameters = pd.read_excel(demand_excel_path, index_col='Demand center')
country_excel_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\country_parameters.xlsx'
country_parameters = pd.read_excel(country_excel_path, index_col='Country')
stores_csv_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\Basic_H2_plant\stores.csv' # H2 storage
stores_parameters = pd.read_csv(stores_csv_path, index_col='name')
storage_csv_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\Basic_H2_plant\storage_units.csv' # Battery
storage_parameters = pd.read_csv(storage_csv_path, index_col='name')
links_csv_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\Basic_H2_plant\links.csv' # Electrolyzer
links_parameters = pd.read_csv(links_csv_path, index_col='name')
generators_csv_path = r'C:\Users\lukas\OneDrive - Imperial College London\0_Thesis\0relevant_repositories\GeoH2 Case Study Laos\Parameters\Basic_H2_plant\generators.csv' # Solar and wind
...
hex_out_geojson_file = 'hex_cost_components.geojson'
hex_out_csv_file = 'hex_cost_components.csv'

# Construct the file paths
hex_out_geojson_path = os.path.join(base_path, year, hex_out_geojson_file)
hex_out_csv_path = os.path.join(base_path, year, hex_out_csv_file)

hexagons.to_file(hex_out_geojson_path, driver='GeoJSON', encoding='utf-8')
hexagons.to_csv(hex_out_csv_path, encoding='latin-1')